...
type PageState = "validating" | "success" | "invalid";
    ...
    <div className="relative min-h-screen bg-base flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-[360px]">
        ...
        <div className="bg-surface border border-white/[0.08] p-6 text-center">
          {state === "validating" && (
            <div className="py-6">
              <div className="w-5 h-5 border-2 border-green border-t-transparent rounded-full animate-spin mx-auto mb-4" />
              <p className="font-sans text-[13px] text-secondary">{t("verifying")}</p>
            </div>
          )}

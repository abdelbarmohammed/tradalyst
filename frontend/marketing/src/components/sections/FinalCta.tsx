  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 50% 60%, rgba(47,172,102,0.18) 0%, transparent 70%)",
        }}
      />

      <div
        ref={ref}
        className="relative max-w-[760px] mx-auto px-6 lg:px-10 text-center"
      >
        <h2
        ...
        >
          Tu próxima operación ya está en los datos.
        </h2>
        ...
        >
          Únete a los traders que ya saben lo que otros no pueden ver.
        </p>

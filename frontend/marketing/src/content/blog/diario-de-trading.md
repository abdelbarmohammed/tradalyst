---
title: "Cómo llevar un diario de trading efectivo (y por qué el 90% lo abandona)"
...
keywords:
  ...
  - "plantilla diario de trading"
  - "diario de trading efectivo"
readTime: 9
lang: "es"
hreflang:
...
featuredImageAlt: "Ejemplo de entrada en un diario de trading digital — Tradalyst"
---
...
## El análisis: lo que pasa después de 30 operaciones
...
Este mismo análisis se aplica a [las métricas de trading que realmente importan](/blog/metricas-trading): el win rate aislado no dice nada; el win rate segmentado por estado emocional lo dice todo. Y también explica [por qué el 80% de los traders pierden dinero](/blog/por-que-pierden-dinero-los-traders) — no es estrategia, es ejecución.
...
1. ¿Cuántas operaciones seguí el plan completamente? ¿Cuántas lo rompí?
2. ¿Hay algún patrón en las operaciones perdedoras? ¿Misma franja horaria, mismo estado emocional, mismo activo?
3. ¿Qué haré diferente la semana que viene?
